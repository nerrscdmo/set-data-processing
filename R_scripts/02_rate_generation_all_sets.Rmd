...
as of 6/9/2025 - would be nice to add start date and end date for each set,
to get length of time series - useful for filtering
also maybe something to let people filter by which vegetation species are dominant

```{r}
write.csv(all_out, here::here("data", "04_rates", "all_rates_and_metadata.csv"))
```
...
# SAVE OUT THESE RATES  
so we can make comparisons to SLR
